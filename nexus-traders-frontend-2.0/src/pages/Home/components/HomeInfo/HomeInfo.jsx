...
const card_data = [
  {
    id: 1,
    img: "./assets/images/vector_art_1-transformed.png",
  ...
  {
    id: 2,
    img: "./assets/images/vector_art_2-transformed.png",
    title: "Doubt Sessions",
    content: "A friendly atmosphere so you can easily ask your doubts.",
  },
  {
    id: 3,
    img: "./assets/images/vector_art_3-transformed.png",
    title: "Team Support",
    content:
  ...
  {
    id: 4,
    img: "./assets/images/vector_art_4-transformed.png",
    title: "Analysis",
    content:
